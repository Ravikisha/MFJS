/**
 * Compile-time type tests for @jorvel/types.
 *
...
const hostConfig: JorvelAppConfig = { name: 'shell', type: 'host', port: 3000 };
void hostConfig;

// type must be 'host' | 'remote' — nothing else
const _badType: JorvelAppConfig = {
  name: 'x',
