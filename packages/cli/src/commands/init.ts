...
export const initCommand = new Command('init')
  ...
  const interactive = !opts.yes && Boolean(process.stdout.isTTY);
    ...
    // jorvel.config.ts
    await writeText(
      path.join(workspaceDir, 'jorvel.config.ts'),
      [
  ...
  console.log(kleur.gray('  jorvel scaffold app  # guided full app scaffold (host + remotes)'));
  console.log(kleur.gray('  jorvel generate host shell'));
  console.log(kleur.gray('  jorvel generate remote dashboard'));
    console.log(kleur.gray('  jorvel dev'));
  });
